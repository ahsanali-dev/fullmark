...
const AdminSkeletonTheme = ({ children }) => {
  ...
  return (
    <SkeletonTheme 
      baseColor={isLight ? "#cbd5e1" : "#0c0d19"} 
      highlightColor={isLight ? "#f1f5f9" : "#16182c"}
    >
      {children}
    </SkeletonTheme>
  );
...
export const DashboardSkeleton = () => {
  const isLight = typeof window !== 'undefined' && (localStorage.getItem('theme') === 'light' || document.documentElement.classList.contains('light'));
  const cardBg = isLight ? 'bg-white border-slate-200 shadow-sm' : 'bg-[#0c0d19]/40 border-gray-800/80';
  const innerBg = isLight ? 'bg-slate-100 border-slate-200' : 'bg-gray-950/20 border-gray-800/50';
    ...
    <AdminSkeletonTheme>
      <div className="px-6 md:px-8 py-4 flex flex-col gap-8 animate-fade-in">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className={`p-5 border rounded-3xl flex flex-col items-center justify-center text-center ${cardBg}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 p-6 border rounded-3xl flex flex-col gap-6 text-left ${cardBg}`}>
            <div className="flex items-center gap-3">
              <Skeleton circle width={40} height={40} />
              <Skeleton width={150} height={20} />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className={`p-5 border rounded-2xl ${innerBg}`}>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[...Array(3)].map((_, i) => (
                <div key={i} className={`p-4 border rounded-3xl flex flex-col items-center justify-center gap-3 ${cardBg}`}>
        ...
        <div className={`p-6 border rounded-3xl flex flex-col gap-5 text-left ${cardBg}`}>
          ...
          <div className="flex flex-col gap-3">
            {[...Array(3)].map((_, i) => (
              <div key={i} className={`flex items-center justify-between p-3.5 border rounded-2xl ${innerBg}`}>
    ...
    <AdminSkeletonTheme>
      <div className="h-full flex flex-col p-4 md:p-8 gap-5 animate-fade-in">
        ...
        <div className="grid grid-cols-4 gap-2.5 md:gap-4 shrink-0">
          {[...Array(4)].map((_, i) => (
            <div key={i} className={`border rounded-2xl md:rounded-3xl p-3 md:p-4 flex flex-col items-center justify-center text-center ${cardBg}`}>
        ...
        <div className="flex flex-col gap-4 shrink-0">
          ...
          <div className={`flex justify-between items-center border-b pb-2 ${isLight ? 'border-slate-200' : 'border-gray-800/40'}`}>
        ...
        <div className="flex-1 overflow-y-auto pr-1 pb-28 flex flex-col gap-3">
          {[...Array(4)].map((_, i) => (
            <div key={i} className={`flex items-center justify-between p-4 border rounded-[1.75rem] ${cardBg}`}>
              <div className="flex items-center gap-3.5">
    ...
    <AdminSkeletonTheme>
      <div className="h-full flex flex-col p-4 md:p-8 gap-5 animate-fade-in">
        ...
        <div className="flex-1 overflow-y-auto pr-1 pb-36 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[...Array(6)].map((_, i) => (
            <div key={i} className={`p-5 border rounded-3xl flex flex-col gap-4 relative ${cardBg}`}>
