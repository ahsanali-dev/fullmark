      ...
      <div className="flex flex-col gap-6 text-start p-4 sm:p-6 md:p-8 pb-32 lg:pb-12 max-w-[1200px] mx-auto w-full">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col gap-6 w-full animate-pulse">
            <div className={`h-8 w-64 rounded-lg ${isLight ? 'bg-slate-200' : 'bg-gray-800'}`} />
            <div className={`h-64 w-full rounded-3xl border ${
              isLight ? 'bg-white border-slate-200' : 'bg-[#0d0d21] border-gray-800'
            }`} />
            <div className="grid grid-cols-3 gap-3">
              {[1, 2, 3].map((i) => (
                <div key={i} className={`h-20 rounded-2xl border ${
                  isLight ? 'bg-white border-slate-200' : 'bg-[#090b17] border-gray-800'
                }`} />
              ))}
            </div>
          </div>
          ...
          >
            ...
            <div className={`relative rounded-[2.2rem] p-4 sm:p-6 transition-all duration-300 overflow-hidden flex flex-col gap-4 sm:gap-5 ${
              isLight 
              ...
              <div className="flex items-center justify-between gap-2 sm:gap-6 min-w-0">
                ...
                <div className="relative shrink-0 flex items-center justify-center w-16 h-16 xs:w-20 xs:h-20 sm:w-28 sm:h-28">
                ...
                <div className="shrink-0 relative flex items-center justify-center -my-2">
                  <div className="absolute inset-0 bg-purple-500/25 blur-2xl rounded-full" />
                  <img 
                    src="/assets/images/robot_mascot.png" 
                    alt="AI Robot Mascot" 
                    className="w-24 xs:w-28 sm:w-36 md:w-40 h-24 xs:h-28 sm:h-36 md:h-40 object-contain relative z-10 filter drop-shadow-[0_0_25px_rgba(168,85,247,0.5)] animate-float transition-transform hover:scale-105 duration-300"
                  />
                </div>
              </div>
              ...
              <div className={`flex items-center gap-1.5 text-xs font-bold ${isLight ? 'text-purple-900' : 'text-indigo-300'} mt-1`}>
                <FiStar className="text-yellow-500 fill-yellow-500 shrink-0" size={13} />
              ...
              <button 
                ...
                className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-black text-sm sm:text-base shadow-[0_0_25px_rgba(99,102,241,0.35)] hover:shadow-[0_0_35px_rgba(168,85,247,0.5)] transition-all cursor-pointer active:scale-[0.99]"
              >
            ...
            <div className="flex flex-col gap-3.5 text-start mt-1">
              ...
              <div className="p-4 sm:p-5 rounded-2xl bg-[#090b17] border border-gray-800/80 flex items-center justify-between gap-4 shadow-md">
                <div className="flex items-center gap-3.5 min-w-0">
                  ...
                  <div className="flex flex-col text-start min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1.5 w-full">
                      <span className="text-[11px] font-bold text-blue-600 dark:text-blue-400">{activeProgress}%</span>
                      <div className="h-1.5 w-24 bg-slate-200 dark:bg-gray-900 rounded-full overflow-hidden border border-slate-300 dark:border-gray-800">
                        <div className="h-full bg-blue-500 rounded-full transition-all duration-500" style={{ width: `${activeProgress}%` }} />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <button 
                  onClick={() => {
                    if (activeEnrollment?.subject?._id) {
                      navigate(`/student/courses/${activeEnrollment.subject._id}`);
                    } else {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                ...
                <div className="p-3.5 sm:p-4 rounded-2xl bg-[#090b17] border border-cyan-500/20 flex items-center justify-between gap-2.5 sm:gap-3 shadow-md hover:border-cyan-500/40 transition-all min-w-0">
                  ...
                  <button 
                    ...
                    className="px-3 sm:px-3.5 py-1.5 rounded-xl bg-cyan-600 hover:bg-cyan-700 dark:bg-cyan-500/10 dark:hover:bg-cyan-500/20 border border-cyan-600 dark:border-cyan-500/40 text-white dark:text-cyan-300 text-xs font-bold transition-all cursor-pointer shrink-0 shadow-sm"
                  >
                ...
                <div className="p-3.5 sm:p-4 rounded-2xl bg-[#090b17] border border-purple-500/20 flex items-center justify-between gap-2.5 sm:gap-3 shadow-md hover:border-purple-500/40 transition-all min-w-0">
                  ...
                  <button 
                    ...
                    className="px-3 sm:px-3.5 py-1.5 rounded-xl bg-purple-600 hover:bg-purple-700 dark:bg-purple-500/10 dark:hover:bg-purple-500/20 border border-purple-600 dark:border-purple-500/40 text-white dark:text-purple-300 text-xs font-bold transition-all cursor-pointer shrink-0 shadow-sm"
                  >
              ...
              <div className="p-3.5 sm:p-5 rounded-2xl bg-[#090b17] border border-gray-800/80 flex flex-col xs:flex-row items-start xs:items-center justify-between gap-3 sm:gap-4 shadow-md">
                ...
                <div className="flex items-center justify-between xs:justify-end gap-3 sm:gap-4 w-full xs:w-auto shrink-0">
                  ...
                  <button 
                    ...
                    className="px-3 sm:px-3.5 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-700 dark:bg-blue-500/10 dark:hover:bg-blue-500/20 border border-blue-600 dark:border-blue-500/40 text-white dark:text-blue-300 text-xs font-bold transition-all cursor-pointer shrink-0 shadow-sm"
                  >
